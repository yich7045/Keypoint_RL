...
class SlacObservation:
    ...
    def reset_episode(self, state, tactile, action):
        ...
        self._action = deque(maxlen=self.num_sequences)
...
class Trainer:
    ...
    def __init__(
        ...
        self.ob = SlacObservation((4, 84, 84), (6,), (3,), num_sequences)
        self.ob_test = SlacObservation((4, 84, 84), (6,), (3,), num_sequences)
    ...
    def train(self):
        ...
        # make it as a small number for backpropagation
        action = [0., 0., 0.]
        self.ob.reset_episode(img, tactile, action)
        self.algo.buffer.reset_episode(img, tactile, action)
    ...
    def evaluate(self, step_env):
        ...
        for i in range(self.num_eval_episodes):
            ...
            tactile = state[1]
            action = [0., 0., 0.]
            self.ob_test.reset_episode(img, tactile, action)
            episode_return = 0.0
            done = False
